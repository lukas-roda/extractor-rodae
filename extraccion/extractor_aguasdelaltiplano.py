...
pdf_directory = os.path.join(uto.ONEDRIVE_PATH, r"Digitalización de facturas (Agua) - Banco Estado\Facturas a procesar\Aguas del altiplano")
...
nombre_archivo = "boletas_aguasdelaltiplano.xlsx"
